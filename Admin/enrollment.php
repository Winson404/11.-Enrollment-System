        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Enrollment records</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header p-2">
                <button class="btn btn-sm btn-primary ml-2" data-toggle="modal" data-target="#addModal"><i class="fa-sharp fa-solid fa-square-plus"></i> New Enrollment</button>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                    <?php
                      $instructor = $db->getEnrolledStudents();
