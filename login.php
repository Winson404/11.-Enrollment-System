<div class="modal fade" id="memberlogin" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-body p-4">
        ...
        <form action="login_code.php" method="POST">
            ...
            <div class="d-flex form-group">
              <button type="submit" class="btn btn-primary" style="width: 20rem;" name="login"><i class="fa-solid fa-right-to-bracket"></i> Login</button>
            </div>
        </form>
        <!-- <p class="mb-4 mt-3" id="link">Don't have an account? <a href="register.php?#register">Click here!</a></p> -->
      </div>
