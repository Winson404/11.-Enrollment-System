<title>Enrollment System | Assigned subject records</title>
<?php 
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Assigned subject records</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                    <?php
                      $acad_year = $db->getAssignedSubjects($id);
