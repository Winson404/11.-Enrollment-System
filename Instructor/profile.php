              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="viewprofile">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0">Hired/End Contract Date</h6>
                      </div>
                      <div class="col-sm-9 text-secondary">
                        <?= $row['hired_date'].' '.$row['contract_end'] ?>
                      </div>
                    </div>
                    <hr>
                    <div class="row">
                  ...
                  <div class="tab-pane" id="accountsecurity">
                    <form id="updateAdminPassword" method="POST" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" value="<?php echo $row['instructor_ID']; ?>" name="updatePassword_user_Id" id="updatePassword_user_Id">
