...
<div class="wrapper">
 ...
 <!--  <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php 
        $student = mysqli_query($conn, "SELECT * FROM student WHERE stud_Id='$id'");
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../images/user.png ?>" alt="User Image" style="height: 34px; width: 34px; border-radius: 50%;">
        </div>
        <div class="info">
          <a href="about_me.php" class="d-block"><?php echo ' '.$row['fname'].' '.$row['mname'].' '.$row['lname'].' '.$row['suffix'].' '; ?></a>
        </div>
      </div>
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
             <div class="modal-header alert-light">
              <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Student logout</h5>
            ...
            <div class="modal-body">
              <form action="../logout.php" method="POST">
                <?php if($row['gender'] === 'Male'):?>
                    <h6 class="text-center">Mr.   <?php echo $row['lname'];?>, are you sure you want to logout?</h6>
                <?php else: ?>
                    <h6 class="text-center">Ma'am <?php echo $row['lname'];?>, are you sure you want to logout?</h6>
                <?php endif; ?>
            </div>
